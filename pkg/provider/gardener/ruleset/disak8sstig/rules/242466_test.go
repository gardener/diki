...
tlsCertFile: /var/lib/certs/tls.crt`
	...
	DescribeTable("Run cases",
		...
		Entry("should return passed checkResults when files have expected permissions",
			...
			[][]error{{nil, nil, nil, nil}, {nil, nil}}, nil,
			[]rule.CheckResult{
				rule.PassedCheckResult("File has expected permissions", rule.NewTarget("cluster", "seed", "name", "etcd", "namespace", "foo", "containerName", "test", "kind", "DaemonSet", "details", "fileName: /destination/bar/file2.pem, permissions: 400")),
				rule.PassedCheckResult("File has expected permissions", rule.NewTarget("cluster", "seed", "name", "etcd", "namespace", "foo", "containerName", "test", "kind", "DaemonSet", "details", "fileName: /destination/file1.crt, permissions: 644")),
				rule.PassedCheckResult("File has expected permissions", rule.NewTarget("cluster", "seed", "name", "etcd-events", "namespace", "foo", "containerName", "test", "kind", "DaemonSet", "details", "fileName: /destination/file3.crt, permissions: 600")),
				rule.PassedCheckResult("File has expected permissions", rule.NewTarget("cluster", "shoot", "name", "proxy", "namespace", "foo", "containerName", "test", "kind", "ReplicaSet", "details", "fileName: /destination/file1.crt, permissions: 644")),
		...
		Entry("should return failed checkResults when files have too wide permissions",
			...
			[]rule.CheckResult{
				...
				rule.FailedCheckResult("File has too wide permissions", rule.NewTarget("cluster", "seed", "name", "etcd", "namespace", "foo", "containerName", "test", "kind", "DaemonSet", "details", "fileName: /destination/bar/file2.pem, permissions: 700, expectedPermissionsMax: 644")),
				rule.FailedCheckResult("File has too wide permissions", rule.NewTarget("cluster", "shoot", "name", "proxy", "namespace", "foo", "containerName", "test", "kind", "ReplicaSet", "details", "fileName: /destination/file1.crt, permissions: 664, expectedPermissionsMax: 644")),
				rule.FailedCheckResult("File has too wide permissions", rule.NewTarget("cluster", "shoot", "name", "proxy", "namespace", "foo", "containerName", "test", "kind", "ReplicaSet", "details", "fileName: /destination/bar/file2.pem, permissions: 700, expectedPermissionsMax: 644")),
