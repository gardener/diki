...
var _ rule.Rule = &Rule242401{}

type Rule242401 struct {
	Client    client.Client
	Namespace string
	Logger    *slog.Logger
}

func (r *Rule242401) ID() string {
	return ID242401
}

func (r *Rule242401) Name() string {
	return "Kubernetes API Server must have an audit policy set (MEDIUM 242401)"
}

func (r *Rule242401) Run(ctx context.Context) (rule.RuleResult, error) {
	const (
