...
func (r *Ruleset) validateV2R6RuleOptions(ruleOptions map[string]internalconfig.IndexedRuleOptionsConfig, fldPath *field.Path) field.ErrorList {
	...
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options254800](ruleOptions[sharedrules.ID254800].Args, fldPath.Index(ruleOptions[sharedrules.ID254800].Index).Child("args"))...)
...
func (r *Ruleset) registerV2R6Rules(ruleOptions map[string]config.RuleOptionsConfig) error { // TODO: add to FromGenericConfig
	...
	opts254800, err := getV2R6OptionOrNil[sharedrules.Options254800](ruleOptions[sharedrules.ID254800].Args)
	if err != nil {
