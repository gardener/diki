...
func (r *Ruleset) registerV1R11Rules(ruleOptions map[string]config.RuleOptionsConfig) error { //nolint:unused // TODO: add to FromGenericConfig
	...
	rules := []rule.Rule{
		...
		&v1r11.Rule242380{Logger: r.Logger().With("rule", v1r11.ID242380), Client: seedClient, Namespace: r.shootNamespace},
		&v1r11.Rule242381{Logger: r.Logger().With("rule", v1r11.ID242381), Client: seedClient, Namespace: r.shootNamespace},
		&v1r11.Rule242382{Logger: r.Logger().With("rule", v1r11.ID242382), Client: seedClient, Namespace: r.shootNamespace},
		&v1r11.Rule242383{},
		&v1r11.Rule242384{},
		&v1r11.Rule242385{},
		...
		&v1r11.Rule242401{Logger: r.Logger().With("rule", v1r11.ID242401), Client: seedClient, Namespace: r.shootNamespace},
		...
		&v1r11.Rule242435{Logger: r.Logger().With("rule", v1r11.ID242435), Client: seedClient, Namespace: r.shootNamespace},
