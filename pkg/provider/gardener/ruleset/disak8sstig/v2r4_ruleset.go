...
func (r *Ruleset) validateV2R4RuleOptions(ruleOptions map[string]internalconfig.IndexedRuleOptionsConfig, fldPath *field.Path) error {
	...
	allErrs = append(allErrs, validateV2R4Options[disaoption.KubeProxyOptions](ruleOptions[sharedrules.ID242400].Args, fldPath.Index(ruleOptions[sharedrules.ID242400].Index).Child("args"))...)
	...
	allErrs = append(allErrs, validateV2R4Options[disaoption.KubeProxyOptions](ruleOptions[sharedrules.ID242466].Args, fldPath.Index(ruleOptions[sharedrules.ID242466].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R4Options[disaoption.KubeProxyOptions](ruleOptions[sharedrules.ID242467].Args, fldPath.Index(ruleOptions[sharedrules.ID242467].Index).Child("args"))...)
...
func (r *Ruleset) registerV2R4Rules(ruleOptions map[string]config.RuleOptionsConfig) error { // TODO: add to FromGenericConfig
	...
	opts242400, err := getV2R4OptionOrNil[disaoption.KubeProxyOptions](ruleOptions[sharedrules.ID242400].Args)
	if err != nil {
	...
	opts242466, err := getV2R4OptionOrNil[disaoption.KubeProxyOptions](ruleOptions[sharedrules.ID242466].Args)
	if err != nil {
		return fmt.Errorf("rule option 242466 error: %s", err.Error())
	}
	opts242467, err := getV2R4OptionOrNil[disaoption.KubeProxyOptions](ruleOptions[sharedrules.ID242467].Args)
	if err != nil {
	...
	opts254800, err := getV2R4OptionOrNil[sharedrules.Options254800](ruleOptions[sharedrules.ID254800].Args)
	if err != nil {
