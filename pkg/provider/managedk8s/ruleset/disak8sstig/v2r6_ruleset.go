...
func (r *Ruleset) validateV2R6RuleOptions(ruleOptions map[string]internalconfig.IndexedRuleOptionsConfig, fldPath *field.Path) field.ErrorList {
	...
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242383](ruleOptions[sharedrules.ID242383].Args, fldPath.Index(ruleOptions[sharedrules.ID242383].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242393](ruleOptions[sharedrules.ID242393].Args, fldPath.Index(ruleOptions[sharedrules.ID242393].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242394](ruleOptions[sharedrules.ID242394].Args, fldPath.Index(ruleOptions[sharedrules.ID242394].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242396](ruleOptions[sharedrules.ID242396].Args, fldPath.Index(ruleOptions[sharedrules.ID242396].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[rules.Options242400](ruleOptions[sharedrules.ID242400].Args, fldPath.Index(ruleOptions[sharedrules.ID242400].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242404](ruleOptions[sharedrules.ID242404].Args, fldPath.Index(ruleOptions[sharedrules.ID242404].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242406](ruleOptions[sharedrules.ID242406].Args, fldPath.Index(ruleOptions[sharedrules.ID242406].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242407](ruleOptions[sharedrules.ID242407].Args, fldPath.Index(ruleOptions[sharedrules.ID242407].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[disaoption.Options242414](ruleOptions[sharedrules.ID242414].Args, fldPath.Index(ruleOptions[sharedrules.ID242414].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[disaoption.Options242415](ruleOptions[sharedrules.ID242415].Args, fldPath.Index(ruleOptions[sharedrules.ID242415].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242417](ruleOptions[sharedrules.ID242417].Args, fldPath.Index(ruleOptions[sharedrules.ID242417].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[rules.Options242442](ruleOptions[sharedrules.ID242442].Args, fldPath.Index(ruleOptions[sharedrules.ID242442].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[option.ClusterObjectSelector](ruleOptions[sharedrules.ID242447].Args, fldPath.Index(ruleOptions[sharedrules.ID242447].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242448](ruleOptions[sharedrules.ID242448].Args, fldPath.Index(ruleOptions[sharedrules.ID242448].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242449](ruleOptions[sharedrules.ID242449].Args, fldPath.Index(ruleOptions[sharedrules.ID242449].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242450](ruleOptions[sharedrules.ID242450].Args, fldPath.Index(ruleOptions[sharedrules.ID242450].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[rules.Options242451](ruleOptions[sharedrules.ID242451].Args, fldPath.Index(ruleOptions[sharedrules.ID242451].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242452](ruleOptions[sharedrules.ID242452].Args, fldPath.Index(ruleOptions[sharedrules.ID242452].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[sharedrules.Options242453](ruleOptions[sharedrules.ID242453].Args, fldPath.Index(ruleOptions[sharedrules.ID242453].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[rules.Options242466](ruleOptions[sharedrules.ID242466].Args, fldPath.Index(ruleOptions[sharedrules.ID242466].Index).Child("args"))...)
	allErrs = append(allErrs, validateV2R6Options[rules.Options242467](ruleOptions[sharedrules.ID242467].Args, fldPath.Index(ruleOptions[sharedrules.ID242467].Index).Child("args"))...)
...
func (r *Ruleset) registerV2R6Rules(ruleOptions map[string]config.RuleOptionsConfig) error { // TODO: add to FromGenericConfig
	...
	opts242383, err := getV2R6OptionOrNil[sharedrules.Options242383](ruleOptions[sharedrules.ID242383].Args)
	if err != nil {
		return fmt.Errorf("rule option 242383 error: %s", err.Error())
	}
	opts242393, err := getV2R6OptionOrNil[sharedrules.Options242393](ruleOptions[sharedrules.ID242393].Args)
	if err != nil {
		return fmt.Errorf("rule option 242393 error: %s", err.Error())
	}
	opts242394, err := getV2R6OptionOrNil[sharedrules.Options242394](ruleOptions[sharedrules.ID242394].Args)
	if err != nil {
		return fmt.Errorf("rule option 242394 error: %s", err.Error())
	}
	opts242396, err := getV2R6OptionOrNil[sharedrules.Options242396](ruleOptions[sharedrules.ID242396].Args)
	if err != nil {
		return fmt.Errorf("rule option 242396 error: %s", err.Error())
	}
	opts242400, err := getV2R6OptionOrNil[rules.Options242400](ruleOptions[sharedrules.ID242400].Args)
	if err != nil {
		return fmt.Errorf("rule option 242400 error: %s", err.Error())
	}
	opts242404, err := getV2R6OptionOrNil[sharedrules.Options242404](ruleOptions[sharedrules.ID242404].Args)
	if err != nil {
		return fmt.Errorf("rule option 242404 error: %s", err.Error())
	}
	opts242406, err := getV2R6OptionOrNil[sharedrules.Options242406](ruleOptions[sharedrules.ID242406].Args)
	if err != nil {
		return fmt.Errorf("rule option 242406 error: %s", err.Error())
	}
	opts242407, err := getV2R6OptionOrNil[sharedrules.Options242407](ruleOptions[sharedrules.ID242407].Args)
	if err != nil {
		return fmt.Errorf("rule option 242407 error: %s", err.Error())
	}
	opts242414, err := getV2R6OptionOrNil[disaoption.Options242414](ruleOptions[sharedrules.ID242414].Args)
	if err != nil {
		return fmt.Errorf("rule option 242414 error: %s", err.Error())
	}
	opts242415, err := getV2R6OptionOrNil[disaoption.Options242415](ruleOptions[sharedrules.ID242415].Args)
	if err != nil {
		return fmt.Errorf("rule option 242415 error: %s", err.Error())
	}
	opts242417, err := getV2R6OptionOrNil[sharedrules.Options242417](ruleOptions[sharedrules.ID242417].Args)
	if err != nil {
		return fmt.Errorf("rule option 242417 error: %s", err.Error())
	}
	opts242442, err := getV2R6OptionOrNil[rules.Options242442](ruleOptions[sharedrules.ID242442].Args)
	if err != nil {
		return fmt.Errorf("rule option 242442 error: %s", err.Error())
	}
	opts242447, err := getV2R6OptionOrNil[option.ClusterObjectSelector](ruleOptions[sharedrules.ID242447].Args)
	if err != nil {
		return fmt.Errorf("rule option 242447 error: %s", err.Error())
	}
	opts242448, err := getV2R6OptionOrNil[sharedrules.Options242448](ruleOptions[sharedrules.ID242448].Args)
	if err != nil {
		return fmt.Errorf("rule option 242448 error: %s", err.Error())
	}
	opts242449, err := getV2R6OptionOrNil[sharedrules.Options242449](ruleOptions[sharedrules.ID242449].Args)
	if err != nil {
		return fmt.Errorf("rule option 242449 error: %s", err.Error())
	}
	opts242450, err := getV2R6OptionOrNil[sharedrules.Options242450](ruleOptions[sharedrules.ID242450].Args)
	if err != nil {
		return fmt.Errorf("rule option 242450 error: %s", err.Error())
	}
	opts242451, err := getV2R6OptionOrNil[rules.Options242451](ruleOptions[sharedrules.ID242451].Args)
	if err != nil {
		return fmt.Errorf("rule option 242451 error: %s", err.Error())
	}
	opts242452, err := getV2R6OptionOrNil[sharedrules.Options242452](ruleOptions[sharedrules.ID242452].Args)
	if err != nil {
		return fmt.Errorf("rule option 242452 error: %s", err.Error())
	}
	opts242453, err := getV2R6OptionOrNil[sharedrules.Options242453](ruleOptions[sharedrules.ID242453].Args)
	if err != nil {
		return fmt.Errorf("rule option 242453 error: %s", err.Error())
	}
	opts242466, err := getV2R6OptionOrNil[rules.Options242466](ruleOptions[sharedrules.ID242466].Args)
	if err != nil {
		return fmt.Errorf("rule option 242466 error: %s", err.Error())
	}
	opts242467, err := getV2R6OptionOrNil[rules.Options242467](ruleOptions[sharedrules.ID242467].Args)
	if err != nil {
