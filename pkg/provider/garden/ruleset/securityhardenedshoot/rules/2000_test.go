...
`
	...
	DescribeTable("Run cases", func(updateFn func(), options *rules.Options2000, expectedCheckResults []rule.CheckResult) {
		...
		Entry("should error if the structuredAuthentication configMap contains an invalid value",
			...
			nil,
			[]rule.CheckResult{{Status: rule.Errored, Message: "yaml: construct errors: line 1: cannot construct !!str `foo` into v1beta1.AuthenticationConfiguration", Target: rule.NewTarget("name", "authentication-config", "namespace", "bar", "kind", "ConfigMap")}},
		),
