...
func (r *Ruleset) validateV2R2RuleOptions(ruleOptions map[string]internalconfig.IndexedRuleOptionsConfig, fldPath *field.Path) error {
	...
	allErrs = append(allErrs, validateV2R2Options[sharedrules.Options242390](ruleOptions[sharedrules.ID242390].Args, fldPath)...)
	allErrs = append(allErrs, validateV2R2Options[disaoption.Options242442](ruleOptions[sharedrules.ID242442].Args, fldPath)...)
	allErrs = append(allErrs, validateV2R2Options[disaoption.FileOwnerOptions](ruleOptions[sharedrules.ID242445].Args, fldPath)...)
	allErrs = append(allErrs, validateV2R2Options[disaoption.FileOwnerOptions](ruleOptions[sharedrules.ID242446].Args, fldPath)...)
	allErrs = append(allErrs, validateV2R2Options[disaoption.FileOwnerOptions](ruleOptions[sharedrules.ID242451].Args, fldPath)...)
	allErrs = append(allErrs, validateV2R2Options[sharedrules.Options245543](ruleOptions[sharedrules.ID245543].Args, fldPath)...)
...
func (r *Ruleset) registerV2R2Rules(ruleOptions map[string]config.RuleOptionsConfig) error { // TODO: add to FromGenericConfig
	...
	opts242442, err := getV2R2OptionOrNil[disaoption.Options242442](ruleOptions[sharedrules.ID242442].Args)
	if err != nil {
		return fmt.Errorf("rule option 242442 error: %s", err.Error())
	}
	opts242445, err := getV2R2OptionOrNil[disaoption.FileOwnerOptions](ruleOptions[sharedrules.ID242445].Args)
	if err != nil {
		return fmt.Errorf("rule option 242445 error: %s", err.Error())
	}
	opts242446, err := getV2R2OptionOrNil[disaoption.FileOwnerOptions](ruleOptions[sharedrules.ID242446].Args)
	if err != nil {
		return fmt.Errorf("rule option 242446 error: %s", err.Error())
	}
	opts242451, err := getV2R2OptionOrNil[disaoption.FileOwnerOptions](ruleOptions[sharedrules.ID242451].Args)
	if err != nil {
