...
// LessRestrictive is a comparator that returns a bool value, based on whether the calling profile is less restrictive than the argument profile that is evaluated.
