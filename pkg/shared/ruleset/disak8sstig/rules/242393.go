...
var (
	...
	_ option.Option          = &Options242393{}
	_ option.MergeableOption = &Options242393{}
)
...
func (o *Options242393) Merge(other option.MergeableOption) (option.MergeableOption, error) {
	if other == nil {
		return o, nil
	}

	otherOpts, err := option.AssertSameType[*Options242393](other)
	if err != nil {
		return nil, err
	}

	merged := &Options242393{
...
func (o Options242393) Validate(fldPath *field.Path) field.ErrorList {
