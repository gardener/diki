...
FROM alpine:3.23.4 AS diki-ops-builder

ARG TARGETARCH

RUN apk --no-cache add curl &&\
    curl -sLf https://github.com/containerd/nerdctl/releases/download/v2.2.2/nerdctl-2.2.2-linux-${TARGETARCH}.tar.gz -o /nerdctl.tar.gz &&\
